...
export const reservations: Reservation[] = [
  {
    ...
    time: '11:25 AM',
    type: 'flight',
    name: 'United Airlines ORD → HND (UA 881)',
    confirmationNumber: 'UA7K3MX',
    partySize: 4,
    notes: "Departs Chicago O'Hare Terminal 1. Arrives Haneda Airport (HND) April 24 ~3:15 PM local time. Check-in opens 24 hrs before departure.",
    itineraryDay: 0,
    status: 'confirmed',
  },
  {
  ...
  },
  {
    ...
    partySize: 4,
    notes: 'Entry time: 08:30-09:00 AM. Must enter during time slot. Wear comfortable clothes and light colors (projections look best on white). Some exhibits have mirror floors — avoid short skirts. Allow 2-3 hrs inside. EN Tea House inside is a must.',
    itineraryDay: 8,
  ...
  },
  {
    ...
    time: '5:15 PM',
    type: 'flight',
    name: 'United Airlines HND → ORD (UA 882)',
    confirmationNumber: 'UA7K3MX',
    partySize: 4,
    notes: "Departs Haneda Airport (HND) at 5:15 PM. Arrives Chicago O'Hare same day ~3:45 PM local time. Allow extra time — May 3 is Constitution Memorial Day (Golden Week).",
    itineraryDay: 10,
    status: 'confirmed',
  },
];
